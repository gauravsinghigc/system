...
if (isset($_POST['value']) && isset($_POST['name'])) {
    if ($_POST['name'] == "Tomorrow") {
        if (AuthAppUser("UserType") == "Admin") {
            $fetclFollowUps = _DB_COMMAND_("SELECT LeadFollowUpHandleBy, LeadFollowUpDescriptions, LeadFollowUpTime, LeadFollowCurrentStatus, LeadFollowMainId, LeadFollowUpUpdatedAt,LeadFollowStatus, LeadFollowUpDate FROM lead_followups, leads where leads.LeadsId=lead_followups.LeadFollowMainId and CompanyID='$companyID'  and (LeadFollowStatus like '%MEETING PLANNED%' OR LeadFollowStatus like '%SITE VISIT PLANNED%') and LeadFollowCurrentStatus like '%FOLLOW-UP%' AND DATE(LeadFollowUpDate)='" . date("Y-m-d", strtotime("+1 days")) . "' and LeadFollowUpRemindStatus='ACTIVE' ORDER BY LeadFollowUpId DESC", true);
        } else {
            $fetclFollowUps = _DB_COMMAND_("SELECT LeadFollowUpHandleBy, LeadFollowUpDescriptions, LeadFollowUpTime, LeadFollowCurrentStatus, LeadFollowMainId, LeadFollowUpUpdatedAt,LeadFollowStatus, LeadFollowUpDate FROM lead_followups,leads where leads.LeadsId=lead_followups.LeadFollowMainId and (LeadFollowStatus like '%MEETING PLANNED%' OR LeadFollowStatus like '%SITE VISIT PLANNED%') and LeadFollowCurrentStatus like '%FOLLOW-UP%' AND LeadFollowUpHandleBy='" . AuthAppUser("UserId") . "' and DATE(LeadFollowUpDate)='" . date("Y-m-d", strtotime("+1 days")) . "' and LeadFollowUpRemindStatus='ACTIVE' ORDER BY LeadFollowUpId DESC", true);
        }
    } elseif ($_POST['name'] == "Missed") {
        if (AuthAppUser("UserType") == "Admin") {
            $fetclFollowUps = _DB_COMMAND_("SELECT LeadFollowUpHandleBy, LeadFollowUpDescriptions, LeadFollowUpTime, LeadFollowCurrentStatus, LeadFollowMainId, LeadFollowUpUpdatedAt,LeadFollowStatus, LeadFollowUpDate FROM lead_followups, leads where leads.LeadsId=lead_followups.LeadFollowMainId and CompanyID='$companyID'  and (LeadFollowStatus like '%MEETING PLANNED%' OR LeadFollowStatus like '%SITE VISIT PLANNED%') and LeadFollowCurrentStatus like '%FOLLOW-UP%' AND DATE(LeadFollowUpDate)<'$TDate' and LeadFollowUpRemindStatus='ACTIVE' ORDER BY LeadFollowUpId DESC", true);
        } else {
            $fetclFollowUps = _DB_COMMAND_("SELECT LeadFollowUpHandleBy, LeadFollowUpDescriptions, LeadFollowUpTime, LeadFollowCurrentStatus, LeadFollowMainId, LeadFollowUpUpdatedAt,LeadFollowStatus, LeadFollowUpDate FROM lead_followups,leads where leads.LeadsId=lead_followups.LeadFollowMainId and (LeadFollowStatus like '%MEETING PLANNED%' OR LeadFollowStatus like '%SITE VISIT PLANNED%') and LeadFollowCurrentStatus like '%FOLLOW-UP%' AND LeadFollowUpHandleBy='" . AuthAppUser("UserId") . "' and DATE(LeadFollowUpDate)<'$TDate' and LeadFollowUpRemindStatus='ACTIVE' ORDER BY LeadFollowUpId DESC", true);
        }
    } elseif ($_POST['name'] == "customDate") {
        if (AuthAppUser("UserType") == "Admin") {
            $fetclFollowUps = _DB_COMMAND_("SELECT LeadFollowUpHandleBy, LeadFollowUpDescriptions, LeadFollowUpTime, LeadFollowCurrentStatus, LeadFollowMainId, LeadFollowUpUpdatedAt,LeadFollowStatus, LeadFollowUpDate FROM lead_followups, leads where leads.LeadsId=lead_followups.LeadFollowMainId and CompanyID='$companyID'  and (LeadFollowStatus like '%MEETING PLANNED%' OR LeadFollowStatus like '%SITE VISIT PLANNED%') and LeadFollowCurrentStatus like '%FOLLOW-UP%' AND DATE(LeadFollowUpDate)='$Missed' and LeadFollowUpRemindStatus='ACTIVE' ORDER BY LeadFollowUpId DESC", true);
        } else {
            $fetclFollowUps = _DB_COMMAND_("SELECT LeadFollowUpHandleBy, LeadFollowUpDescriptions, LeadFollowUpTime, LeadFollowCurrentStatus, LeadFollowMainId, LeadFollowUpUpdatedAt,LeadFollowStatus, LeadFollowUpDate FROM lead_followups,leads where leads.LeadsId=lead_followups.LeadFollowMainId and (LeadFollowStatus like '%MEETING PLANNED%' OR LeadFollowStatus like '%SITE VISIT PLANNED%') and LeadFollowCurrentStatus like '%FOLLOW-UP%' AND LeadFollowUpHandleBy='" . AuthAppUser("UserId") . "' and DATE(LeadFollowUpDate)='$Missed' and LeadFollowUpRemindStatus='ACTIVE' ORDER BY LeadFollowUpId DESC", true);
        }
    } else {
                ...
                <span class=''>
                    ...
                    <?php } else { ?>
                        <span class="p-t-3 text-black">
                            <span class='h4 text-black'><i class='fas fa-handshake'></i></span><br>
                            <span class='small'>Meeting Planned at </span><br>
