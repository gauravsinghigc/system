...
<body class="pb-5 mb-5">
    ...
    <main id="main" class="main">
        <div class="pagetitle animate-fade-up">
            <div class="flex-s-b">
                <div>
                    <h1 class="app-heading"><i class="bi bi-person text-warning bold"></i> Add New Contacts</h1>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="<?php echo CONTROLLER; ?>/ModuleController/LeadsController.php" method="POST" enctype="multipart/form-data" class="row g-2" id="leadForm">
                    ...
                    <input type="hidden" name="leads_assigned_to" value="<?php echo LOGIN_USER_ID; ?>">
                    <!-- Personal Details -->
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="card form-section">
                            <div class="card-header" data-bs-toggle="collapse" data-bs-target="#addressDetails">
                                <i class="bi bi-geo-alt me-2"></i> Address Details
                            </div>
                            <div id="addressDetails" class="collapse show">
                                <div class="card-body">
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            <label class="form-label">Address</label>
                                            <textarea class="form-control" name="leads_address_line1" rows="2"></textarea>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Area Locality</label>
                                            <input type="text" class="form-control" name="leads_address_area">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">City</label>
                                            <input type="text" class="form-control" name="leads_address_city">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">State</label>
                                            <input type="text" class="form-control" name="leads_address_state">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Country</label>
                                            <input type="text" class="form-control" name="leads_address_country" value="India">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Pincode</label>
                                            <input type="text" class="form-control" name="leads_address_pincode" maxlength="6">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Address Type</label>
                                            <select name="leads_address_type" class="form-control">
    ...
    <script>
        ...
        if (isSupported) {
            ...
            startSpeechBtn.addEventListener('click', function() {
                if (this.classList.contains('recording')) {
                    ...
                    try {
                        ...
                        alert("Voice recognition could not be started. Try refreshing or use another browser.");
                    }
                }
            });
            ...
            // WebView fallback - use Android native voice
            console.log("Browser not supported. Using Android native interface.");

            startSpeechBtn.addEventListener('click', function() {
                AndroidInterface.startVoiceInput(); // Call Android method
            });

            // This function is called from Android after receiving voice input
            window.setVoiceResult = function(text) {
                feedbackRemarks.value += (feedbackRemarks.value ? ' ' : '') + text;
            };

        } else {
            // Not supported
            console.warn("SpeechRecognition or AndroidInterface not supported.");
            startSpeechBtn.disabled = true;
            startSpeechBtn.innerHTML = '<i class="bi bi-x-circle"></i> Voice Input Not Supported';
        }
    </script>
