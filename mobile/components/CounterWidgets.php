<div class="row mt-2">
    ...
    if ($AllStages != null) {
        ...
        $StageCountsQuery = "SELECT leads_stages, SUM(leads_type='LEAD') AS total_leads, SUM(leads_type='DATA') AS total_data, COUNT(leads_id) AS total_records FROM leads WHERE $LoginLevelConditions and leads_is_removed!='1' GROUP BY leads_stages";
