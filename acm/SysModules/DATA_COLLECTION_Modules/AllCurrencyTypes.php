<?php
function CURRENCY_LIST($default, $return = "options", $results = null)
{
  $currencies = array(
  ...
  if ($return == "options") {
    ...
    foreach ($currencies as $code => $value) {
      ...
      echo "<option value='$code' $selected>" . $value['name'] . " (" . $value['symbol'] . ")</option>";
    }
  }
}

//function for display current symbole
function CURRENCY_DISPLAY($name = null, $res = "symbol")
{
