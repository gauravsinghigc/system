    ...
    <div class="login-box">
        <div class="card">
            <div class="card-header text-center">
                ...
                <br>
                <a href="<?php echo DOMAIN; ?>" class="h5"><i class='fa fa-edit text-success'></i> Reset Your Password</a>
            </div>
            <div class="card-body">
                <?php if (isset($_GET['token'])) {
                    ...
                    if ($CurrentDateTime <= $PasswordChangeTokenExpireTime) {
                        if ($RequiredToken == $ReceivedToken) { ?>
                            <form role="form" action="<?php echo CONTROLLER; ?>/authcontroller.php" method="POST">
                                ...
                                <br>
                                <button type="submit" name="RequestForPasswordChange" class="btn btn btn-success btn-sm p-2">
                        ...
                        <?php } else {
                            ...
                            <a href="<?php echo DOMAIN; ?>/auth/forget/">Password Reset</a><br>
                            <a href="<?php echo DOMAIN; ?>/auth/login">Back to Login</a>
                        <?php }
                    } else {
                        $PasswordChangeRequestStatus = "Expired";
                        $PasswordChangeToken = $RequiredToken;
