...
function initGmag() {
  ...
  var mianVidLink = $(".video-links-wrap .video-item"),
    ...
    stisDataUrlCatUrlAct = mianVidLinkAct
      .find(".post-category-marker")
      .attr("href"),
  ...
  videoHolder
    .find(".bg")
    .css("background-image", "url(" + stisDataUrlbgAct + ")");
  videoHolderTitle
    .find(".video-holder-title_item a")
    .attr("href", stisDataUrlAct);
  ...
  videoHolderTitle
    .find(".post-category-marker")
    .attr("href", stisDataUrlCatUrlAct);
  mianVidLink.on("click", function () {
    ...
    setTimeout(function () {
      ...
      videoHolder
        .find(".bg")
        .css("background-image", "url(" + stisDataUrlbg + ")");
      videoHolderTitle
        .find(".video-holder-title_item a")
        .attr("href", stisDataUrl);
