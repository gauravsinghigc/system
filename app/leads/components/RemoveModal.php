 ...
 <div id="removeModal" class="modal">
     <div class="modal-content">
         <div class="modal-header app-heading p-2">
             <h5 class="modal-title" id="my-modal-title">Remove Leads Storage</h5>
         </div>
         <form class="row" method="POST" action="<?php echo CONTROLLER; ?>/ModuleController/LeadsController.php">
             ...
             <div class="col-md-12 text-right">
                 <hr>
                 <button type="submit" class="btn btn-primary btn-md" name="RemoveSelectedLeads"><i class="bi bi-check-circle text-success"></i> Remove Selected Records</button>
