                            ...
                            <div class="tab-content mt-3" id="activityTabContent">
                                ...
                                <div class="tab-pane fade show active" id="call-feedback" role="tabpanel" aria-labelledby="call-feedback-tab">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h5 class="app-sub-heading text-primary fw-bold w-75 mb-0 mt-0"><i class="bi bi-telephone-fill me-2"></i>Call Feedback</h5>
                                        <button class="btn btn-primary btn-md w-50" data-bs-toggle="modal" data-bs-target="#addCallFeedbackModal">
                                ...
                                <div class="tab-pane fade" id="reminders" role="tabpanel" aria-labelledby="reminders-tab">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h5 class="app-sub-heading text-primary fw-bold w-75 mb-0 mt-0"><i class="bi bi-bell-fill me-2"></i>Reminders</h5>
                                        <button class="btn btn-primary btn-md ml-1 w-50" data-bs-toggle="modal" data-bs-target="#addReminderModal">
                                ...
                                <div class="tab-pane fade" id="site-visits" role="tabpanel" aria-labelledby="site-visits-tab">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h5 class="app-sub-heading text-primary fw-bold w-75 mb-0 mt-0"><i class="bi bi-geo-alt-fill me-2"></i>Site Visits</h5>
                                        <button class="btn btn-primary btn-md ml-1 w-50" data-bs-toggle="modal" data-bs-target="#addSiteVisitModal">
                                                    ...
                                                    <div class="d-flex align-items-start">
                                                        ...
                                                        <div class="timeline-content p-3 bg-white rounded shadow-sm flex-grow-1 border-start border-primary">
                                                            ...
                                                            <div class="mt-2">
                                                                ...
                                                                <br>
                                                                <span class="detail-title fw-bold">Reminder Note:</span>
                                                                <?php echo SECURE($SiteVisits->leads_site_visit_notes); ?>
                                                                <br>
                                                                <?php
