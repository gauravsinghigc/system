 <section class="section animate-fade-up">
     ...
     <div class="row">
         <div class="col-md-12 text-center mb-1">
             <a href="<?php echo APP_URL; ?>/meetings" class="btn btn-sm btn-primary text-white">📅 All Site Visits <b><?php echo TOTAL($SiteVisitSQL); ?></b></a>
             <a href="?getSiteVisitFor=<?php echo DATE("Y-m-d", strtotime("-1 days")); ?>" class="btn btn-sm btn-warning text-white">🕰️ Yesterday Site Visits : <b><?php echo TOTAL($SiteVisitSQL . " and DATE(leads_site_visit_schedule_date)='" . DATE("Y-m-d", strtotime("-1 days")) . "'"); ?></b></a>
             <a href="?getSiteVisitFor=<?php echo DATE("Y-m-d"); ?>" class="btn btn-sm btn-success text-white">📅 Today Site Visits : <b><?php echo TOTAL($SiteVisitSQL . " and DATE(leads_site_visit_schedule_date)='" . DATE("Y-m-d") . "'"); ?></b></a>
             <a href="?getSiteVisitFor=<?php echo DATE("Y-m-d", strtotime("+1 days")); ?>" class="btn btn-sm btn-danger text-white">🔮 Tomorrow Site Visits : <b><?php echo TOTAL($SiteVisitSQL . " and DATE(leads_site_visit_schedule_date)='" . DATE("Y-m-d", strtotime("+1 days")) . "'"); ?></b></a>
