                 ...
                 <?php
                    ...
                    if ($AllProjects != null) {
                        foreach ($AllProjects as $AllProject) {
                            ...
                            $SelectedProject = CheckEquality($projects_id, IfRequested("GET", "leads_site_visits_projects_id", "", false), "selected");
                 ...
                 <?php
                    ...
                    if ($AllUsers != null) {
                        foreach ($AllUsers as $AllUser) {
                            ...
                            $SelectedUser = CheckEquality($UserId, IfRequested("GET", "leads_site_visit_handled_by", "", false), "selected");
                 ...
                 <?php
                    ...
                    if ($AllUsers != null) {
                        foreach ($AllUsers as $AllUser) {
                            $UserId = $AllUser->UserId;
                            $UserFullName = $AllUser->UserFullName;
                            $SelectedUser = CheckEquality($UserId, IfRequested("GET", "leads_site_visit_created_by", "", false), "selected");
                            echo "<option value='$UserId' $SelectedUser>$UserFullName</option>";
                        }
                    } ?>
             </select>
